...
Neither approach fully solves the problem of successful adoption of best practices in writing. Few people have the resources to outsource editing to expert staff. Even if they did, the process is slow because copy editors must read the text carefully and are normally unavailable during the act of writing. By the time an editor's notes are received, then, the best opportunity to strengthen the writer's craft has passed. This problem is exacerbated for time-sensitive writing, where the delay introduced by an external editor may diminish the communication's value. Existing software-based tools, though they are inexpensive and fast, are typically incomplete, imprecise, or inaccessible (see Existing Tools, below). 
