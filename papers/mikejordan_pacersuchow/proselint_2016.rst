...
Though it has not been used in any extensive linguistic studies to date, Proselint fits the formal structure expected by many language-science techniques, but with a feature set that emphasizes different information --- usage and style choices rather than word frequencies and syntax trees. 
